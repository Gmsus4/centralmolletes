        ...
        <div className="flex flex-col lg:flex-row gap-10 items-start">
            ...
            <div className="relative mb-4 p-10 rounded-3xl bg-brand-primary overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs tracking-widest uppercase text-text-main/80 font-semibold">Última actualización: Abril 2026</span>
                </div>
          ...
          <aside className="hidden lg:flex flex-col gap-4 w-72 shrink-0 sticky top-24 self-start">
            ...
            <div className="rounded-2xl border-1 border-border-color/10 bg-backgroundMin p-5 flex flex-col gap-3">
              ...
              <Link href="/privacy" className="w-full text-center border-1 border-border-color/10 dark:border-foreground/10 bg-transparent rounded-xl border-1 border-border-color font-title text-lg py-1 hover:bg-bg-dark/5 transition-colors">
                Aviso de Privacidad
              </Link>
            </div>
          </aside>
