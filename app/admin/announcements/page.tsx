...
export default async function AnnouncementsPage() {
  ...
  return (
    <LayoutAdminSection namePage="Anuncios" maxWidth="max-w-6xl" link={{ label: "Nuevo anuncio", href: "/admin/announcements/new" }}>
      <Suspense>
      ...
      {announcements.length === 0 ? (
        <EmptyState
          icon={Megaphone}
          label="Sin anuncios activos"
          description="Parece que no tienes campañas en marcha. Crea tu primer anuncio para llegar a más clientes."
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2">
                  <Badge variant="outline" className={`gap-1.5 text-[10px] uppercase tracking-wide font-medium ${meta.badge}`}>
                ...
                <div className="flex-1">
                  <p className="font-titleText text-foreground text-xl uppercase leading-tight group-hover:text-muted-foreground transition-colors">{announcement.title}</p>
                  {announcement.message && <p className="text-xs text-muted-foreground mt-2 leading-relaxed line-clamp-2">{announcement.message}</p>}
                </div>
                ...
                <div className="flex items-end justify-between">
                  ...
                  <div className="text-right">
                    {hasta ? (
                      ...
                      <span className="text-[10px] uppercase tracking-wide text-muted-foreground">Sin expiración</span>
                    )}
                  </div>
                </div>
