...
export const SITE_CONTENT_SECTIONS = [
  ...
  { value: "about",               label: "Nuestra Historia", description: "Información narrativa, misión y mensaje de bienvenida de la marca." },
  ...
  { value: "methodology",         label: "Nuestra Forma de Trabajar", description: "Título, descripción y los 4 features con ícono." },
  { value: "featured_products",   label: "Productos Destacados", description: "Configuración del tag y encabezado para mostrar los primeros 4 productos." },
] as const
